...
GitBook 集成允许您将 GitBook 空间连接到一些您喜欢的平台和服务。您可以从左上角的“集成”菜单将集成安装到 GitBook 页面中。
